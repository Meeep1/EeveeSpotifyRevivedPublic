...
It also includes an optional true shuffle toggle in Settings > Patching, which disables Spotify's weighted recommendation injection path for a more random shuffle order.
